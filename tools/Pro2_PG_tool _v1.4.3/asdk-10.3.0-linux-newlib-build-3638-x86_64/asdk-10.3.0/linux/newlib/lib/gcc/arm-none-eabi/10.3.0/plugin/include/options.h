...
enum opt_code
{
  ...
  OPT_mapcs = 1609,                          /* -mapcs */
  OPT_mapcs_frame = 1610,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1611,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1612,              /* -mapcs-stack-check */
  OPT_march_ = 1613,                         /* -march= */
  OPT_marm = 1614,                           /* -marm */
  OPT_masm_syntax_unified = 1615,            /* -masm-syntax-unified */
  OPT_mbe32 = 1616,                          /* -mbe32 */
  OPT_mbe8 = 1617,                           /* -mbe8 */
  OPT_mbig_endian = 1618,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 1619,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1620,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1621,     /* -mcaller-super-interworking */
  OPT_mcmse = 1622,                          /* -mcmse */
  OPT_mcpu_ = 1623,                          /* -mcpu= */
  OPT_mfdpic = 1624,                         /* -mfdpic */
  OPT_mfix_cortex_m3_ldrd = 1625,            /* -mfix-cortex-m3-ldrd */
  OPT_mfix_vldstr = 1626,                    /* -mfix-vldstr */
  OPT_mflip_thumb = 1627,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1628,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1629,                  /* -mfp16-format= */
  OPT_mfpu_ = 1630,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1631,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 1632, */              /* -mhard-float */
  OPT_mlittle_endian = 1633,                 /* -mlittle-endian */
  OPT_mlong_calls = 1634,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1635,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1636,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1637,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1638,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1639,               /* -mprint-tune-info */
  OPT_mpure_code = 1640,                     /* -mpure-code */
  OPT_mrestrict_it = 1641,                   /* -mrestrict-it */
  OPT_msched_prolog = 1642,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1643,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1644,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1645, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1646,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1647,                         /* -mthumb */
  OPT_mthumb_interwork = 1648,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1649,                  /* -mtls-dialect= */
  OPT_mtp_ = 1650,                           /* -mtp= */
  OPT_mtpcs_frame = 1651,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1652,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1653,                         /* -mtune= */
  OPT_munaligned_access = 1654,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1655,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1656,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1657,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1658,              /* -mword-relocations */
  OPT_n = 1659,                              /* -n */
  ...
  OPT_pie = 1679,                            /* -pie */
  OPT_pipe = 1680,                           /* -pipe */
  OPT_print_file_name_ = 1681,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1682,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1683,          /* -print-multi-directory */
  OPT_print_multi_lib = 1684,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1685,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1686,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1687,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1688,               /* -print-prog-name= */
  OPT_print_search_dirs = 1689,              /* -print-search-dirs */
  OPT_print_sysroot = 1690,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1691,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1692,                    /* -print-value */
  OPT_quiet = 1693,                          /* -quiet */
  OPT_r = 1694,                              /* -r */
